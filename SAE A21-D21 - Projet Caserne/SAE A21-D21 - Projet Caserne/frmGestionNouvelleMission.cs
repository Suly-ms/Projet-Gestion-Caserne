    ...
    public partial class FrmGestionNouvelleMission : Form
    {
        ...
        private void btnValider_Click(object sender, EventArgs e)
        {
            if(!(txbVille.Text=="" || txbRue.Text == "" || txbCodePostal.Text == "" || pompierVehiculeMission == null))
            {
                ...
                insertIntoMission.CommandText = $"INSERT INTO Mission(id, dateHeureDepart, motifAppel, adresse, cp, ville, terminee, idNatureSinistre, idCaserne) VALUES({numeroMission}, '{DateTime.Now}', '{txbMotif.Text.Replace("'", "''")}', '{txbRue.Text.Replace("'", "''")}', '{txbCodePostal.Text.Replace("'", "''")}', '{txbVille.Text.Replace("'", "''")}', 0, {cbxNatureSinistre.SelectedValue}, {cbxCaserne.SelectedValue})";
